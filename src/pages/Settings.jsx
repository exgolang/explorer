...
export default class Settings extends React.Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            nodeUri : localStorage.getItem('mix-node-uri') || 'https://nodeagr.info'
        };
        ...
        return <div className="settings-page row content-page">
            <div className="col-md-12">
                <div className="panel panel-default">
                    <div className="panel-heading">Connection settings</div>
                    <div className="panel-body">
                        <p>
                            The Aigar Block Explorer can connect to an Aigar blockchain via two methods:
                        </p>
                        <ul>
                            <li>
                    ...
                    <div className="col-md-12 metamask-exists">
                        Metamask is &nbsp;
                        {
