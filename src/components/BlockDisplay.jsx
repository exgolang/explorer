...
class TransactionsList extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div className="transactions-list row content-page">
                <div className="col-md-12">
                    <div className="panel panel-default">
                        <div className="panel-heading">Transaction list</div>
...
export default class BlockDisplay extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <div className="block-display content-page">
                <div className="row">
                    <div className="col-md-12 table-responsive">
                        <div className="panel panel-default">
                            <div className="panel-heading">Block Information</div>
                            <div className="panel-body">
                                <table className="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                    <span className="block-display-value">{this.props.block.difficulty.toString(10)}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
